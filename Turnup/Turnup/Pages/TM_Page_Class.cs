...
namespace Turnup.Pages
{
    ...
    {
        public void Create_Time_Record_Func(IWebDriver driver)
        {
        ...
        public void Edit_Time_Record_Func(IWebDriver driver)
        {
            Console.WriteLine("\nNow cursor entered into Edit_Time_Record_Func().");
            //Now edit the last record
            //Now go to last page
            Thread.Sleep(4000);
            //Wait_Class.Wait_To_Be_Element_Exist(driver, "XPath", "//*[@id=\"tmsGrid\"]/div[4]/a[4]/span", 20);
            ...
            Thread.Sleep(4000);
            //IWebElement newCode = driver.FindElement(By.XPath("//*[@id='tmsGrid']/div[3]/table/tbody/tr[last()]/td[1]")); //*[@id="tmsGrid"]/div[3]/table/tbody/tr[3]/td[1]
